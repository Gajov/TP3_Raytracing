...
/**
 * Um Vector3 pode representar (a) um vetor geométrico, (b) um ponto no espaço
 * ou (c) uma cor. Todos os métodos não alteram o próprio objeto, mas retornam
 * um novo Vector3 com o resultado da operação. Por exemplo:
 * 
...
public class Vector3 {
    ...
    /**
     * CONSTRUTOR que recebe 3 doubles como parâmetro. Como usar:
     *   Vector3 v = new Vector3(10.0f, 0, 1.0f);
     *
     * @param x valor de x.
     * @param y valor de y.
     * @param z valor de z.
    ...
    /**
     * CONSTRUTOR que recebe outro Vector3 e cria um clone. Como usar:
     * Vector3 v = new Vector3(10.0f, 0, 1.0f);
    ...
    ///-------------------------------------------------------------------------
    /**
     * MÉTODO para adicionar um vetor ao outro. Como usar:
    ...
    /**
     * MÉTODO para subtrair um vetor do outro. Como usar:
     *   Vector3 a = new Vector3(10, 20, 30);
     *   Vector3 b = new Vector3(5, 5, 5);
    ...
    /**
     * MÉTODO para calcular o produto interno (escalar) entre dois 
     * vetores (a . b). Como usar:
     *   Vector3 a = new Vector3(1, 0, 0);
     *   Vector3 b = new Vector3(0, 1, 0);
    ...
    /**
     * MÉTODO para calcular a norma do vetor. Como usar:
     ...
     * truncadas entre 0 e 1. Como usar:
